...
int main() {
  ...
  // b1, b2, b3 が決まった
  for (int i = 0; i < 3; i++) b[i] = G[0][i];

  // a2 を確認
  if (G[1][0] - b[0] != G[1][1] - b[1]) { cout << "No" << endl; return 0; }
  if (G[1][1] - b[1] != G[1][2] - b[2]) { cout << "No" << endl; return 0; }
  if (G[1][2] - b[2] != G[1][0] - b[0]) { cout << "No" << endl; return 0; }

  if (G[2][0] - b[0] != G[2][1] - b[1]) { cout << "No" << endl; return 0; }
  if (G[2][1] - b[1] != G[2][2] - b[2]) { cout << "No" << endl; return 0; }
  if (G[2][2] - b[2] != G[2][0] - b[0]) { cout << "No" << endl; return 0; }
  ...
  for (int i = 0; i < 3; i++) {
    for (int j = 0; j <3; j++) {
      if (G[i][j] != a[i]+b[j]) { cout << "No" << endl; return 0; }
    }
  }
