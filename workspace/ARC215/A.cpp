...
int main() {
  ...
  else if (BN[0]>0 && BN[1]>0 && firstcost > 0)
  {
    if (T[0] != A[0]) cout << firstcost + BN[0] + BN[1] << endl;
    else cout << 1 + firstcost + BN[0] + BN[1] << endl;
  }
  else if (BN[0]==0) {
    if (T[0]!=A[0]) cout << firstcost + BN[1] << endl;
    else cout << BN[1] << endl;
  }
  else if (BN[1]==0) {
    if (T[0]!=A[0]) cout << firstcost + BN[0] << endl;
    else cout << BN[0] << endl;
  } 
